    ...
    return (
      <div className="frontside mb-3">
          <div className="card-student-list" onClick={this.handleClick} data-email=""data-name="" data-score="" data-photo="" data-label="" data-value="">
            <div className="card-body-student d-flex">
